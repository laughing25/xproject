...
- (void)setupControllers {
    ...
    _catagoryVC = [[XLPeiJianViewController alloc] init];
    [self setupChildViewController:_catagoryVC title:@"Tabbar_Peijian" imageName:@"tab_categories" selectedImageName:@"tab_categories_selected"];
    ...
    _cartVC = [[XLFaXianViewController alloc] init];
    [self setupChildViewController:_cartVC title:@"Tabbar_FaXian" imageName:@"tab_cart" selectedImageName:@"tab_carts_selected"];
